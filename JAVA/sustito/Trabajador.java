...
public class Trabajador extends Empleado {
	...
	public void getSueldoCompleto() {
		...
		if ("limpieza" == area.toLowerCase()) {
			setHorasExtra(11);
		}else if((area.toLowerCase().equals("administracion"))||(area.toLowerCase().equals("administración"))||(area.toLowerCase().equals("enfermería"))||(area.toLowerCase().equals("enfermeria"))) {
			setHorasExtra(15);
		}else {
