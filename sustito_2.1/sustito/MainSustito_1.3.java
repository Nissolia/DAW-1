...
public class MainSustito {
	...
	private Persona crearEstudiante() {
		// TODO Auto-generated method stub
return new Estudiante(nombre, ape1, ape2, dni, anio, mes, dia, telefono, email,
		idEstudiante, grado, curso, notaMedia);

	}

	private Persona crearProfesor() {
		// TODO Auto-generated method stub
		return new Profesor(nombre, ape1, ape2, dni, anio, mes, dia, telefono, email,
				idTrabajador, horasTrabajo, horasExtra, sueldoBase, new Fecha(anioAnt, mesAnt, diaAnt),
				departamento, asignatura, tutor);
		
	}

	private Persona crearEmleado() {
		// TODO Auto-generated method stub
		return new Trabajador(nombre, ape1, ape2, dni, anio, mes, dia, telefono, email,
				idTrabajador, horasTrabajo, horasExtra, sueldoBase, area);
	}
}// Fuera de la clase
