...
public class Acronimos {
	...
	public static void main(String[] args) {
		...
		for (int i = 0; i < limitFrases; i++) {
			...
			/*
			 * Usamos maxAcronimo para tener el array de String que deseamos, en el cual
			 * añadiremos las letras mayúsculas que tengamos en el array de frase
			 */
			String[] acronimo = new String[maxAcronimo];
		}
	...
	/*****************/
	/*
	 * comprobación de la mayúscula que se está haciendo
	 */
